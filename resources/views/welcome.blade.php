    ...
    <section class="bg-gray-200">
        <div class="flex justify-center">
            <div class="px-20 py-32 lg:w-1/2">
                <div class="w-full ">
                    <h1 class="mb-2 text-4xl font-medium text-gray-900">Welcome to my Blog 
                    </h1>
                    <div class="leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus
                        ...
                        <button
                        class="px-8 py-2 mt-4 text-xl text-white hover:shadow-2xl bg-gradient-to-b from-yellow-300 to-yellow-500 rounded-xl">Get
                        started</button>
                    </div>
            ...
            @foreach ($popularArticles as $article)
                <div class="relative mx-6">
                    <div class="bg-white rounded-lg shadow-md">
                        <img src="{{ $article->getFirstMediaUrl('articles', 'thumb') }}" class="object-cover object-center w-full h-56 rounded-t-lg">
                        <div class="absolute bottom-32 right-4 text-white bg-yellow-500 px-2 py-0.5 rounded-xl">
                            {{ $article->category->name }}
                        </div>
                        <div class="p-6">
                            <h2 class="mb-2 text-2xl font-medium text-gray-800">{{ $article->title }}</h2>
                            <a href="{{ route('blog.show', $article) }}" class="text-base text-yellow-600">Read More </a>
                        </div>
                    </div>
                </div>
            @endforeach
