                    ...
                    <form method="POST" action="{{ route('articles.update', $article) }}" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="mb-3">
                                ...
                                <x-jet-input id="title" class="block w-full mt-1" type="text" name="title" :value="$article->title" autofocus autocomplete="title" />
                            ...
                            <div class="mb-3">
                                ...
                                <x-trix name="body" styling="overflow-y-scroll h-96">{{ $article->body }}</x-trix>
                            ...
                            <div class="mb-3">
                                ...
                                <x-pikaday name="published_at" format="YYYY-MM-DD" value="{{ $article->published_at }}"/>
